 ...
 *
 * Initialise the system tick Timer_Device and its interrupt and start the
 * system tick Timer_Device / counter in free running mode to generate 
...
{ 
  ...
  SysTick->CTRL  = SysTick_CTRL_CLKSOURCE_Msk | 
                   ...
                   SysTick_CTRL_ENABLE_Msk;                    /* Enable SysTick IRQ and SysTick Timer_Device */
